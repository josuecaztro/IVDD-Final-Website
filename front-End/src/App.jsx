...
import DisplayGivePage from './components/DonatePage/Give';
...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/donate" element={<DisplayGivePage language={language}/>}/>
      <Route path="/donate/online" element={<DisplayDonatePage language={language}/>}/>
