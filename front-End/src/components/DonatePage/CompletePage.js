...
export default function CompletePage() {
  ...
  return (
    <div id="payment-status">
      <div id="donation-status-icon" style={{backgroundColor: STATUS_CONTENT_MAP[status].iconColor}}>
      ...
      {intentId && <a href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details" className="a-a-a" rel="noopener noreferrer" target="_blank">View details
      ...
      <a id="donation-retry-button" href="/checkout">Test another</a>
    </div>
  );
}