...
const videoData = {
    en: {
      ...
      'Marriage': [
        ...
        { title: 'Eye for Eye, Tooth for Tooth', date:"10/29/2024", url: 'https://www.youtube.com/embed/SmzsSMRp-hA?si=EFbi0ohM4nBq4bYy', desc:"This message explores the principle of \"an eye for an eye\" and emphasizes that in marriage, we should follow Jesus' new teachings. Unity is key—focus on self-reflection instead of retaliation. Discover more insights in this message!" }
      ]
    },
    es: {
      'Discipleship': [
